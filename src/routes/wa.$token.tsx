...
export const Route = createFileRoute("/wa/$token")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Kirim kode hasil ke bot cpnsguru.id lewat WhatsApp." },
    ],
  }),
    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="mx-auto max-w-xl px-4 py-16">
        <div className="rounded-lg border border-border bg-card p-8 text-center shadow-sm">
          ...
          <h1 className="mt-4 text-2xl font-bold">Kode hasil sudah siap</h1>
          <p className="mt-2 text-sm text-muted-foreground">
            Buka WhatsApp lalu kirim pesan yang sudah terisi. Bot akan mengonfirmasi permintaan,
            kemudian mengirim hasil rasionalisasi sebagai gambar.
          </p>
          ...
          <div className="mt-4 flex items-start gap-2 rounded-lg bg-muted/60 p-3 text-left text-xs text-muted-foreground">
            ...
            <span>
              Proses dimulai setelah kode dikirim. Hasil akan dikirim maksimal 10 menit dan biasanya
              selesai lebih cepat.
            </span>
          </div>
        </div>
